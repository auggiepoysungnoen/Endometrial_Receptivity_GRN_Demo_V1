...
[`local_host_development/workflow/progress.txt`](local_host_development/workflow/progress.txt).

- **Live demo:** https://auggiepoysungnoen.github.io/Endometrial_Receptivity_GRN_Demo_V1/
- **Repo:** https://github.com/auggiepoysungnoen/Endometrial_Receptivity_GRN_Demo_V1 (tag `demo_v1`)
...
```bash
git clone https://github.com/auggiepoysungnoen/Endometrial_Receptivity_GRN_Demo_V1.git
cd Endometrial_Receptivity_GRN_Demo_V1
```
...
```bash
python3 local_host_development/script/build_territory_graph.py stromal
...
node local_host_development/script/tests/browser_smoke.js http://127.0.0.1:8000/local_host_development/site/
```
